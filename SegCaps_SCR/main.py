...
if __name__ == '__main__':
    ...
    #parser.add_argument('--data_root_dir', type=str, required=False, default = 'C:/Users/212673708/Documents/TAU/semesterB/DeepLearningInMedicalImaging/SegCaps-master/data',
    #                    help='The root directory for your data.')
    #parser.add_argument('--data_root_dir', type=str, required=False, default = 'data',
    #                   help='The root directory for your data.')
    #parser.add_argument('--data_root_dir', type=str, required=False, default = 'liver_data',
    #                   help='The root directory for your data.')
    parser.add_argument('--data_root_dir', type=str, required=False, default = 'liver_data3',
                       help='The root directory for your data.')
    #parser.add_argument('--data_root_dir', type=str, required=False, default = 'D:/TAU/semesterB/DeepLearningInMedicalImaging/liver/liver_data',
    #                    help='The root directory for your data.')
    #parser.add_argument('--data_root_dir', type=str, required=False, default = 'C:/Users/212673708/Documents/TAU/semesterB/DeepLearningInMedicalImaging/SegCaps-master/data_new_ct_liver',
    #                    help='The root directory for your data.')

    parser.add_argument('--weights_path', type=str, default='saved_models_original/segcapsr3/model5.hdf5',
                        help='/path/to/trained_model.hdf5 from root. Set to "" for none.')
    #parser.add_argument('--weights_path', type=str, default='saved_models/segcapsr3/model_epoch.hdf5',
    #                    help='/path/to/trained_model.hdf5 from root. Set to "" for none.')
    #parser.add_argument('--weights_path', type=str, default='saved_models/unet/unetLuna.hdf5',
    #                    help='/path/to/trained_model.hdf5 from root. Set to "" for none.')
    #parser.add_argument('--weights_path', type=str, default='',
    #                   help='/path/to/trained_model.hdf5 from root. Set to "" for none.')
    #parser.add_argument('--weights_path', type=str, default='C:/Users/212673708/Documents/TAU/semesterB/DeepLearningInMedicalImaging/modelLiverNew.hdf5',
    #                    help='/path/to/trained_model.hdf5 from root. Set to "" for none.')
    #parser.add_argument('--weights_path', type=str, default='C:/Users/212673708/Documents/TAU/semesterB/DeepLearningInMedicalImaging/model_10epoch.hdf5',
    #                    help='/path/to/trained_model.hdf5 from root. Set to "" for none.')
    #parser.add_argument('--weights_path', type=str, default='C:/Users/212673708/Documents/TAU/semesterB/DeepLearningInMedicalImaging/modelLuna.hdf5',
    #                    help='/path/to/trained_model.hdf5 from root. Set to "" for none.')
